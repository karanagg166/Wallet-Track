...
const StackedBarPage: React.FC = () => {
  ...
  useEffect(() => {
    fetchChartData('/api/charts/expense/paymentmethod/days', setDataDate, setLoadingDate);
    fetchChartData('/api/charts/expense/paymentmethod/months', setDataMonth, setLoadingMonth);
    fetchChartData('/api/charts/expense/paymentmethod/years', setDataYear, setLoadingYear);
  }, [startDate, endDate]);
