...
const StackedBarPage: React.FC = () => {
  ...
  const fetchChartData = async (
    url: string,
    setter: React.Dispatch<React.SetStateAction<IncomeData[]>>,
  ...
  useEffect(() => {
    fetchChartData('/api/charts/incomes/incomesource/days', setDataDate, setLoadingDate);
    fetchChartData('/api/charts/incomes/incomesource/months', setDataMonth, setLoadingMonth);
    fetchChartData('/api/charts/incomes/incomesource/years', setDataYear, setLoadingYear);
  }, [startDate, endDate]);
